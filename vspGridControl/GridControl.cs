...
namespace Microsoft.SqlServer.Management.UI.Grid
{
    ...
    public class GridControl : Control, ISupportInitialize, IGridControl
    {
        #region Variables
        ...
        private string GetClipboardTextForSelectionBlock(int nBlockNum)
        {
            ...
            return this.GetClipboardTextForCells(y, bottom, x, right);
        }
        ...
        public DataObject GetDataObject(bool bOnlyCurrentSelBlock)
        {
            ...
            return this.GetDataObjectInternal(bOnlyCurrentSelBlock);
        }
        ...
        protected virtual DataObject GetDataObjectInternal(bool bOnlyCurrentSelBlock)
        {
            ...
            if (bOnlyCurrentSelBlock)
            {
                ...
                builder.Append(this.GetClipboardTextForSelectionBlock(this.m_selMgr.CurrentSelectionBlockIndex));
            }
            else
            {
                ...
                {
                    builder.Append(this.GetClipboardTextForSelectionBlock(i));
                    if (i < (count - 1))
                    {
        ...
        protected bool HandleStdCellLBtnDown(System.Windows.Forms.Keys modKeys)
        {
            ...
            {
                flag4 = !this.HandleStartCellEditFromStdCellLBtnDown(editType, rowIndex, columnIndex, bNotifySelChange);
                if (!flag4)
                {
                    return false;
                }
            ...
            else if ((modKeys & System.Windows.Forms.Keys.Control) != System.Windows.Forms.Keys.None)
            {
                ...
                {
                    flag5 = this.m_selMgr.StartNewBlockOrExcludeCell(rowIndex, columnIndex);
                    if (!flag5)
                    {
        ...
        protected virtual HitTestInfo HitTestInternal(int nMouseX, int nMouseY)
        {
            ...
            if ((headerButton != HitTestResult.ColumnResize) && (headerButton != HitTestResult.HeaderButton))
            {
                ...
                switch (column.ColumnType)
                {
                    ...
                    case 6:
                        customCell = HitTestResult.TreeCell;
                        break;
        ...
        {
            string clipboardTextForSelectionBlock = this.GetClipboardTextForSelectionBlock(this.m_captureTracker.SelectionBlockIndex);
        ...
        protected virtual void SelectedCellsInternal(BlockOfCellsCollection col, bool bSet)
        {
            ...
            else
            {
                ...
                if (col != null)
                {
                    foreach (BlockOfCells cells2 in col)
                    {
                        this.m_selMgr.StartNewBlock(cells2.Y, cells2.X);
                        this.m_selMgr.UpdateCurrentBlock(cells2.Bottom, cells2.Right);
                    }
                }
                this.OnSelectionChanged(this.m_selMgr.SelectedBlocks);
                base.Invalidate();
